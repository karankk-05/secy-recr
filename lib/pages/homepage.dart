...
class _HomePageState extends State<HomePage> {
  Widget _appbar(BuildContext context) {
    ...
    // mytext.context = context; // Remove this if `mytext` is not defined.
    return Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'Newly Arrived',
                        style:mytext.headingbold(fontSize: 17)
                      ),
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                  gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                    maxCrossAxisExtent: 220.0, // Set the max cross axis extent
                    ...
                    (context, index) {
                      if (!displayAll && index >= 7) {
                        return Container(); // Return an empty container if not displaying all and index is beyond 3
                      }
                      return ProductTile(
